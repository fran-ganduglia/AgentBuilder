...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    optionalIntegrations: ["hubspot", "salesforce", "google_calendar"],
  ...
  },
  {
    ...
    optionalIntegrations: ["gmail", "whatsapp", "hubspot", "salesforce"],
  ...
  },
  {
    ...
    category: "sales",
    requiredIntegrations: ["google_calendar"],
    optionalIntegrations: ["hubspot", "salesforce", "gmail"],
    allowedAutomationPresets: ["copilot", "assisted"],
    defaultAutomationPreset: "copilot",
    defaultInstanceConfig: {
      language: "es",
  ...
  },
  {
    ...
    optionalIntegrations: ["hubspot", "salesforce"],
    allowedAutomationPresets: ["copilot"],
    defaultAutomationPreset: "copilot",
    defaultInstanceConfig: {
      language: "es",
  ...
  },
  {
    ...
    optionalIntegrations: ["teams", "hubspot", "salesforce"],
    allowedAutomationPresets: ["copilot"],
    defaultAutomationPreset: "copilot",
    defaultInstanceConfig: {
      language: "es",
  ...
  },
  {
    ...
    category: "operations",
    requiredIntegrations: ["slack"],
    optionalIntegrations: ["teams", "google_calendar", "hubspot", "salesforce"],
    allowedAutomationPresets: ["copilot", "assisted"],
  ...
  },
  {
    ...
    optionalIntegrations: ["whatsapp", "salesforce", "hubspot", "gmail", "google_calendar"],
