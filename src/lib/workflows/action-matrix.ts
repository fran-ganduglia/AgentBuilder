...
const ACTION_MATRIX: WorkflowActionMatrixEntry[] = [
  ...
  { provider: "gmail", action: "send_reply", access: "write", sync: false, async: true, requiresConfirmation: true, workflowTriggerable: false, allowedPresets: ["assisted", "autonomous"], approvalTimeoutMs: DEFAULT_APPROVAL_TIMEOUT_MS, riskLevel: "high", allowedScopes: ALL_AGENT_SCOPES, scopeKeywords: { support: ["ticket", "reclamo", "incidente", "soporte", "caso"], sales: ["lead", "prospecto", "propuesta", "cotizacion", "demo", "follow-up", "follow up"], operations: ["interno", "aprobacion", "reporte", "reporting", "comite", "coordinacion"] } },
